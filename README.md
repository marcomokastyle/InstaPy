...
_If user posts are not in the range of min_media and max_media user is skipped. If min_media and max_media are both set to 0, no restriction are applied._
